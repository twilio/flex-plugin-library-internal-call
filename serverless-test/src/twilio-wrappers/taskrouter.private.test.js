...
describe('taskrouter.createTask', () => {
  ...
  it('createTask gives success', async () => {
    const { createTask } = require('../../../serverless/src/functions/twilio-wrappers/taskrouter.private');
...
describe('taskrouter.fetchTask', () => {
  ...
  it('fetchTask gives success', async () => {
    const { fetchTask } = require('../../../serverless/src/functions/twilio-wrappers/taskrouter.private');
...
describe('taskrouter.updateTaskAttributes', () => {
  ...
  it('updateTaskAttributes gives success', async () => {
    const { updateTaskAttributes } = require('../../../serverless/src/functions/twilio-wrappers/taskrouter.private');
