...
jest.mock('../../../serverless/src/functions/twilio-wrappers/conference-participant.private.js', () => ({
  __esModule: true,
...
describe('Remove Participant', () => {
  ...
  it('CleanUpTask is called successfully ', async () => {
    const CleanUp = require('../../../serverless/src/functions/voice/cleanup-rejected-task');
